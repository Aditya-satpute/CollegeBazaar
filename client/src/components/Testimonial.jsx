...
function Testimonial () {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl">
            <Title title="What Our Customer Say" subTitle="This is a subtitle ihfjewvef fhfdfio ei fhufhuerifg ekfb johofvhoe vefeuoefehf f  fiofhfuh vief yoivje  vepiu"/>
